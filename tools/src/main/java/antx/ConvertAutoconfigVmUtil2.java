 ...
 * @time: 17/9/17
 */
public class ConvertAutoconfigVmUtil2 {

    public static void main(String[] args) throws IOException {

        ConvertAutoconfigVmUtil2.batchConvert("/Users/weigangpeng/IdeaProjects/aegean_home/shixi/bundle/war/src/resources/", "/Users/weigangpeng/IdeaProjects/aegean_home/shixi/bundle/war/src/resources2/");
    ...
    public static void convert(File oldFile, String rootPath, String outputPath) throws IOException {
        ...
        File newFile = new File(oldFile.getAbsolutePath().replace(rootPath, outputPath).replace(".xml", ".xml.vm"));
